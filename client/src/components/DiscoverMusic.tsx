...
const mockMatches = [
  {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Giddha"],
    learning : ["Want To Learn Odissi Sangeet"],
  ...
  },
   {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Villu Pattu"],
    learning : ["Want To Learn Lavani"],
  ...
  },
   {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Bihu Geet"],
    learning : ["Want To Learn Sufiana Kalam"],
...
const DiscoverMusic: React.FC<DiscoverMusicProps> = ({ user, onLogout }) => {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Discover Cultural Musics
          </h1>
          <p className="text-gray-600">
            Find people from different states to exchange Music with
          </p>
        </div>
