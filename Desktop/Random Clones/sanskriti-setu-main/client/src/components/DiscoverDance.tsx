...
const mockMatches = [
  {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Bhangra"],
    learning : ["Want To Learn Kuchipudi"],
  ...
  },
   {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Kathakali"],
    learning : ["Want To Learn Kathak "],
  ...
  },
   {
    ...
    matchScore: 92,
    commonInterests: ["Teaches Bihu"],
    learning : ["Want To Learn BharatNatyam"],
